  ...
  return (
    <section id="home" className="relative overflow-hidden bg-gradient-to-b from-secondary to-background">
      ...
      <div className="pointer-events-none absolute inset-0 opacity-5">
        ...
        <svg className="absolute right-20 top-40 h-20 w-20 -rotate-12 text-green" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 10.5c-1.5 0-2.5 1.5-2.5 3s1 3 2.5 3 2.5-1.5 2.5-3-1-3-2.5-3zm-4.5-2c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zm9 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5zm-6.5-3c-.83 0-1.5.67-1.5 1.5S9.17 8.5 10 8.5s1.5-.67 1.5-1.5S10.83 5.5 10 5.5zm4 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5-.67-1.5-1.5-1.5z"/>
        </svg>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-2">
              <Heart className="h-5 w-5 text-green" fill="currentColor" />
            ...
            <p className="max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
              Dr. Bill Howard and his team have served the people of Akron and surrounding towns since 2006. We provide excellent veterinary care in a compassionate, friendly, and relaxed atmosphere.
            </p>
            <div className="flex flex-wrap gap-4 pt-2">
              {/* Deep red — Call button */}
              <Button asChild size="lg" className="gap-2 bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-md">
                <a href="tel:574-893-4028">
                  <Phone className="h-4 w-4" />
                  Call (574) 893-4028
                </a>
              </Button>
              {/* Forest green — Schedule button */}
              <Button
                asChild
                size="lg"
                className="gap-2 border-2 border-green bg-green text-white hover:bg-green/90 font-bold shadow-md"
              >
                <Link href="#contact">
            ...
            <div className="absolute -bottom-6 -left-6 rounded-xl border border-border bg-card p-4 shadow-lg sm:-bottom-8 sm:-left-8 sm:p-6">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-green/10">
                  <Heart className="h-6 w-6 text-green" fill="currentColor" />
                </div>
                <div>
